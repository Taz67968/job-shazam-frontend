        ...
        <div className="w-full md:w-1/2 p-6 md:p-10 flex flex-col justify-center">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-3 bg-green-500 hover:bg-green-600 rounded-md font-semibold text-white transition text-sm flex items-center justify-center"
            >
              {isLoading ? (
          ...
          <p className="mt-4 text-gray-400 text-sm flex justify-center">
            ...
            <Link href="/loginPage" className="text-green-400 hover:underline ml-1">
              Login here
            </Link>
          </p>
        </div>
